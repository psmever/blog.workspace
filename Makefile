...
help:
	...
	@echo "  make deploy-backend    → 서버에서 backend develop → main 승격 후 배포"
	@echo "  make deploy-frontend   → 서버에서 frontend develop → main 승격 후 배포"
	@echo "  make deploy-all        → 서버에서 backend -> frontend 순서로 승격 및 배포"
